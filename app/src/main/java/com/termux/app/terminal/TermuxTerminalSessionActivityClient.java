...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    public void addNewSession(boolean isFailSafe, String sessionName, String executablePath) {
        addNewSession(isFailSafe, sessionName, executablePath, null);
    }

    public void addNewSession(boolean isFailSafe, String sessionName, String executablePath, String[] processArgs) {
        TermuxService service = mActivity.getTermuxService();
        if (service == null) return;
        ...
        if (service.getTermuxSessionsSize() >= MAX_SESSIONS) {
            ...
            TermuxSession newTermuxSession = service.createTermuxSession(executablePath, processArgs, null, workingDirectory, isFailSafe, sessionName);
